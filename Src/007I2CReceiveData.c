...
int main(void)
{
	...
	while (1) {
		...
		I2C_MasterSendData(&I2C_Handle, &command_code, 1, SLAVE_ADDR,I2C_ENABLE_SR);

		I2C_MasterReceiveData(&I2C_Handle, &length, 1, SLAVE_ADDR, I2C_ENABLE_SR);

		command_code = 0x52;

		I2C_MasterSendData(&I2C_Handle, &command_code, 1, SLAVE_ADDR, I2C_ENABLE_SR);

		I2C_MasterReceiveData(&I2C_Handle, RVC_Msg, length, SLAVE_ADDR, I2C_DISABLE_SR);
